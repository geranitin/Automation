...
st.title("LLM Agents at work: Article writer")
#st.markdown("##### :orange_heart: Searches the web for articles /n Reads and summarizes each article using llama3:8b /n Writes a News Article using llama3:70b")
st.markdown("1.Searches the web for articles  \n 2.Reads and summarizes each article using llama3:8b  \n 3.Writes an Article using llama3:70b")
