        ...
        try:
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                if file_key not in st.session_state.get('file_cache', {}):
                    ...
                    qa_prompt_tmpl_str = (
                    "RFP Trend Analysis: Extracting Key Customer Requirements and Objectives\n"
                    "-----------------------------------------------------------------------\n"
                    "Context Information:\n"
                    "---------------------\n"
                    "{context_str}\n"
                    "---------------------\n"
                    "Given the context information above, please provide insights into the RFP objective and the top 3 customer requirements.\n"
                    "Query: {query_str}\n"
                    "Answer: "
                    )
...
with col1:
    st.header(f"RFP trend analysis_BO Use case")
